...
var AudioConfig = /** @class */ (function () {
    ...
    AudioConfig.fromMicrophoneInput = function (deviceId) {
        ...
        // deviceId was being passed in to audioInputId
        // for purposes of this sample, it is set to null as a workaround
        return new AudioConfigImpl(new Exports_1.MicAudioSource(pcmRecorder, AudioInputStream_1.bufferSize, null, deviceId));
    };
    /**
